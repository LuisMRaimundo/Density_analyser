...
class DensityCalculatorGUI:
    ...
    def _create_interface(self):
        ...
        # Criar um frame principal para conter a secção de entrada e a secção de resultados/controlos
        main_frame = tk.Frame(self.root)
        main_frame.pack(fill=tk.BOTH, expand=True)

        # Criar um frame para a parte direita (resultados, controlos, etc.)
        right_frame = tk.Frame(main_frame)
        right_frame.pack(side=tk.RIGHT, fill=tk.BOTH, expand=True, padx=10, pady=10)

        # Criar canvas com barra de rolagem para as entradas de notas (à esquerda)
        ...
        # Mover todos os outros controlos para o `right_frame`
        ...
        # Criar campos de entrada para 60 notas no `input_frame`
        ...
        stevens_frame = tk.LabelFrame(right_frame, text="Lei de Stevens")
        ...
        psycho_frame = tk.LabelFrame(right_frame, text="Correcções Psicoacústicas")
        ...
        perceptual_frame = tk.LabelFrame(right_frame, text="Configurações de Densidade Intervalar")
        ...
        # Botões principais (movidos para o final e empacotados em `right_frame`)
        self._create_main_buttons(right_frame)
    ...
    def _create_main_buttons(self, parent_frame):
